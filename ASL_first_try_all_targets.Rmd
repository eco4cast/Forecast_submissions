...
I think my vision is that we would set things up to loop through all themes and run the following code (so not running all simultaneously). But could be convinced otherwise!
```{r}
...
This is filled in for our null model starting point, but will need to modify down the road
```{r}
